...
* functions.
*/
uint8 USBMIDI_1_initVar = 0u;

#if (USBMIDI_1_EP_MANAGEMENT_DMA)
    #if (CY_PSOC4)
        static void USBMIDI_1_InitEpDma(void);

        /* DMA chanels assigend for endpoints. */
        const uint8 USBMIDI_1_DmaChan[USBMIDI_1_MAX_EP] =
        {
            0u,
            0u,
            0u,
    ...
    #else
        /* DMA chanels assigend for endpoints. */
        uint8 USBMIDI_1_DmaChan[USBMIDI_1_MAX_EP];
        
        /* DMA TDs require for PSoC 3/5LP operation. */
        uint8 USBMIDI_1_DmaTd[USBMIDI_1_MAX_EP];
    #endif /* (CY_PSOC4) */
    ...
    uint8  USBMIDI_1_DmaEpBurstCnt   [USBMIDI_1_MAX_EP];
    
    /* Number of bytes to transfer in last DMA burst. */
    uint8  USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_MAX_EP];

    /* Storage for arrays above. */
    uint8  USBMIDI_1_DmaEpBurstCntBackup  [USBMIDI_1_MAX_EP];
    uint32 USBMIDI_1_DmaEpBufferAddrBackup[USBMIDI_1_MAX_EP];
     
    /* DMA trigger mux output for usb.dma_req[0-7]. */
    const uint8 USBMIDI_1_DmaReqOut[USBMIDI_1_MAX_EP] =
    {
        0u,
        USBMIDI_1_ep1_dma__TR_OUTPUT,
        USBMIDI_1_ep2_dma__TR_OUTPUT,
        USBMIDI_1_ep3_dma__TR_OUTPUT,
        USBMIDI_1_ep4_dma__TR_OUTPUT,
        USBMIDI_1_ep5_dma__TR_OUTPUT,
        0u,
        0u,
        0u,
    };
    ...
    const uint8 USBMIDI_1_DmaBurstEndOut[USBMIDI_1_MAX_EP] =
    {
        0u,
        USBMIDI_1_BURSTEND_0_TR_OUTPUT,
        USBMIDI_1_BURSTEND_1_TR_OUTPUT,
        USBMIDI_1_BURSTEND_2_TR_OUTPUT,
        USBMIDI_1_BURSTEND_3_TR_OUTPUT,
        USBMIDI_1_BURSTEND_4_TR_OUTPUT,
        USBMIDI_1_BURSTEND_5_TR_OUTPUT,
        USBMIDI_1_BURSTEND_6_TR_OUTPUT,
        USBMIDI_1_BURSTEND_7_TR_OUTPUT
    };
    
#else
    #if (USBMIDI_1_EP_DMA_AUTO_OPT == 0u)
        static uint8 clearInDataRdyStatus = USBMIDI_1_ARB_EPX_CFG_DEFAULT;
        uint8 USBMIDI_1_DmaNextTd[USBMIDI_1_MAX_EP];
        const uint8 USBMIDI_1_epX_TD_TERMOUT_EN[USBMIDI_1_MAX_EP] =
        {
            0u,
            0u,
            0u,
        ...
        volatile uint16 USBMIDI_1_inLength[USBMIDI_1_MAX_EP];
        const uint8 *USBMIDI_1_inDataPointer[USBMIDI_1_MAX_EP];
        volatile uint8 USBMIDI_1_inBufFull[USBMIDI_1_MAX_EP];
...
*   following list.
*
*       *USBMIDI_1_3V_OPERATION* - Disable voltage regulator and pass-
*                                      through Vcc for pull-up
*
*       *USBMIDI_1_5V_OPERATION* - Enable voltage regulator and use
*                                      regulator for pull-up
*
*       *USBMIDI_1_DWR_POWER_OPERATION* - Enable or disable the voltage
...
{
    if (0u == USBMIDI_1_initVar)
    {
        USBMIDI_1_Init();
        USBMIDI_1_initVar = 1u;
    }

    USBMIDI_1_InitComponent(device, mode);
}


/*******************************************************************************
* Function Name: USBMIDI_1_Init
****************************************************************************//**
*
...
* USBMIDI_1_Init() because the USBMIDI_1_Start() routine calls
...
void USBMIDI_1_Init(void) 
{
    ...
    * USBMIDI_1_InitComponent() if it is required.
    */

    /* Enable USBIO control on drive mode of D+ and D- pins. */
    USBMIDI_1_USBIO_CR1_REG &= ~ (uint32) USBMIDI_1_USBIO_CR1_IOMODE;

    /* Set number of LF CLK to detect UBS bus reset. */
    USBMIDI_1_BUS_RST_CNT_REG = USBMIDI_1_DEFUALT_BUS_RST_CNT;
    ...
    */
    USBMIDI_1_POWER_CTRL_REG = USBMIDI_1_DEFAULT_POWER_CTRL_VBUS;

    /* Enable PHY detector and single-ended and differential receivers. */
    USBMIDI_1_POWER_CTRL_REG |= USBMIDI_1_DEFAULT_POWER_CTRL_PHY;
    ...
    USBMIDI_1_CR1_REG = USBMIDI_1_DEFUALT_CR1;
    ...
    USBMIDI_1_INTR_SIE_MASK_REG = USBMIDI_1_DEFAULT_INTR_SIE_MASK;
    ...
    USBMIDI_1_CR1_REG = USBMIDI_1_CR1_ENABLE_LOCK;
    ...
    */
    ...
    USBMIDI_1_USBIO_CR1_REG &= (uint8) ~USBMIDI_1_USBIO_CR1_IOMODE;
    ...
    CyDelayUs(USBMIDI_1_WAIT_REG_STABILITY_1US);
    ...
    USBMIDI_1_DM_INP_DIS_REG &= (uint8) ~USBMIDI_1_DM_MASK;
    USBMIDI_1_DP_INP_DIS_REG &= (uint8) ~USBMIDI_1_DP_MASK;
    ...
    CY_SET_REG8(USBMIDI_1_ARB_RW1_WA_PTR,     0u);
    CY_SET_REG8(USBMIDI_1_ARB_RW1_WA_MSB_PTR, 0u);

#if (USBMIDI_1_EP_MANAGEMENT_DMA)
    /* Initialize transfer descriptor. This will be used to detect DMA state - initialized or not. */
    for (i = 0u; i < USBMIDI_1_MAX_EP; ++i)
    {
        USBMIDI_1_DmaTd[i] = DMA_INVALID_TD;

    #if (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u))
        USBMIDI_1_DmaNextTd[i] = DMA_INVALID_TD;
    ...
    CyIntSetPriority     (USBMIDI_1_INTR_HI_VECT_NUM,  USBMIDI_1_INTR_HI_PRIORITY);
    (void) CyIntSetVector(USBMIDI_1_INTR_HI_VECT_NUM, &USBMIDI_1_INTR_HI_ISR);

    /* Configure lo_int: set handler and priority. */
    CyIntSetPriority     (USBMIDI_1_INTR_LO_VECT_NUM,  USBMIDI_1_INTR_LO_PRIORITY);
    (void) CyIntSetVector(USBMIDI_1_INTR_LO_VECT_NUM, &USBMIDI_1_INTR_LO_ISR);

    /* Configure med_int: set handler and priority (routed through DSI). */
    CyIntSetPriority     (USBMIDI_1_INTR_MED_VECT_NUM,  USBMIDI_1_INTR_MED_PRIORITY);
    (void) CyIntSetVector(USBMIDI_1_INTR_MED_VECT_NUM, &USBMIDI_1_INTR_MED_ISR);

#else
    /* Set bus reset interrupt. */
    CyIntSetPriority(USBMIDI_1_BUS_RESET_VECT_NUM, USBMIDI_1_BUS_RESET_PRIOR);
    (void) CyIntSetVector(USBMIDI_1_BUS_RESET_VECT_NUM,   &USBMIDI_1_BUS_RESET_ISR);

    /* Set Control Endpoint Interrupt. */
    CyIntSetPriority(USBMIDI_1_EP_0_VECT_NUM, USBMIDI_1_EP_0_PRIOR);
    (void) CyIntSetVector(USBMIDI_1_EP_0_VECT_NUM,   &USBMIDI_1_EP_0_ISR);

    /* Set SOF interrupt. */
    #if (USBMIDI_1_SOF_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_SOF_VECT_NUM,  USBMIDI_1_SOF_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_SOF_VECT_NUM, &USBMIDI_1_SOF_ISR);
    #endif /* (USBMIDI_1_SOF_ISR_ACTIVE) */

    /* Set Data Endpoint 1 Interrupt. */
    #if (USBMIDI_1_EP1_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_1_VECT_NUM,  USBMIDI_1_EP_1_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_1_VECT_NUM,  &USBMIDI_1_EP_1_ISR);
    #endif /* (USBMIDI_1_EP1_ISR_ACTIVE) */

    /* Set Data Endpoint 2 Interrupt. */
    #if (USBMIDI_1_EP2_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_2_VECT_NUM,  USBMIDI_1_EP_2_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_2_VECT_NUM, &USBMIDI_1_EP_2_ISR);
    #endif /* (USBMIDI_1_EP2_ISR_ACTIVE) */

    /* Set Data Endpoint 3 Interrupt. */
    #if (USBMIDI_1_EP3_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_3_VECT_NUM,  USBMIDI_1_EP_3_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_3_VECT_NUM, &USBMIDI_1_EP_3_ISR);
    #endif /* (USBMIDI_1_EP3_ISR_ACTIVE) */

    /* Set Data Endpoint 4 Interrupt. */
    #if (USBMIDI_1_EP4_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_4_VECT_NUM,  USBMIDI_1_EP_4_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_4_VECT_NUM, &USBMIDI_1_EP_4_ISR);
    #endif /* (USBMIDI_1_EP4_ISR_ACTIVE) */

    /* Set Data Endpoint 5 Interrupt. */
    #if (USBMIDI_1_EP5_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_5_VECT_NUM,  USBMIDI_1_EP_5_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_5_VECT_NUM, &USBMIDI_1_EP_5_ISR);
    #endif /* (USBMIDI_1_EP5_ISR_ACTIVE) */

    /* Set Data Endpoint 6 Interrupt. */
    #if (USBMIDI_1_EP6_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_6_VECT_NUM,  USBMIDI_1_EP_6_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_6_VECT_NUM, &USBMIDI_1_EP_6_ISR);
    #endif /* (USBMIDI_1_EP6_ISR_ACTIVE) */

     /* Set Data Endpoint 7 Interrupt. */
    #if (USBMIDI_1_EP7_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_7_VECT_NUM,  USBMIDI_1_EP_7_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_7_VECT_NUM, &USBMIDI_1_EP_7_ISR);
    #endif /* (USBMIDI_1_EP7_ISR_ACTIVE) */

    /* Set Data Endpoint 8 Interrupt. */
    #if (USBMIDI_1_EP8_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_EP_8_VECT_NUM,  USBMIDI_1_EP_8_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_EP_8_VECT_NUM, &USBMIDI_1_EP_8_ISR);
    #endif /* (USBMIDI_1_EP8_ISR_ACTIVE) */

    /* Set ARB Interrupt. */
    #if (USBMIDI_1_EP_MANAGEMENT_DMA && USBMIDI_1_ARB_ISR_ACTIVE)
        CyIntSetPriority     (USBMIDI_1_ARB_VECT_NUM,  USBMIDI_1_ARB_PRIOR);
        (void) CyIntSetVector(USBMIDI_1_ARB_VECT_NUM, &USBMIDI_1_ARB_ISR);
    #endif /* (USBMIDI_1_EP_MANAGEMENT_DMA && USBMIDI_1_ARB_ISR_ACTIVE) */
#endif /* (CY_PSOC4) */

    /* Common: Configure GPIO interrupt for wakeup. */
#if (USBMIDI_1_DP_ISR_ACTIVE)
    CyIntSetPriority     (USBMIDI_1_DP_INTC_VECT_NUM,  USBMIDI_1_DP_INTC_PRIORITY);
    (void) CyIntSetVector(USBMIDI_1_DP_INTC_VECT_NUM, &USBMIDI_1_DP_ISR);
#endif /* (USBMIDI_1_DP_ISR_ACTIVE) */

#if (USBMIDI_1_EP_MANAGEMENT_DMA && CY_PSOC4)
    /* Initialize DMA channels. */
    USBMIDI_1_InitEpDma();
#endif /* (USBMIDI_1_EP_MANAGEMENT_DMA && CY_PSOC4) */
}


/*******************************************************************************
* Function Name: USBMIDI_1_InitComponent
****************************************************************************//**
*
...
*
* \globalvars
*   \ref USBMIDI_1_device
*   \ref USBMIDI_1_transferState
*   \ref USBMIDI_1_configuration
*   \ref USBMIDI_1_deviceStatus
*
*   \ref USBMIDI_1_deviceAddress - Contains the current device address. This
...
*      SET_ADDRESS request.
*
*   \ref USBMIDI_1_lastPacketSize - Initialized to 0;
*
* \reentrant
*  No.
*
...
void USBMIDI_1_InitComponent(uint8 device, uint8 mode) 
{
    ...
    */
    ...
    {
        USBMIDI_1_hidProtocol[i] = USBMIDI_1_PROTOCOL_REPORT;
    }
#endif /* USBMIDI_1_ENABLE_HID_CLASS */

    /* Store device number to access descriptor. */
    USBMIDI_1_device = device;

    /* Reset component internal variables. */
    USBMIDI_1_transferState   = USBMIDI_1_TRANS_STATE_IDLE;
    USBMIDI_1_configurationChanged = 0u;
    USBMIDI_1_configuration   = 0u;
    USBMIDI_1_interfaceNumber = 0u;
    USBMIDI_1_deviceAddress   = 0u;
    USBMIDI_1_deviceStatus    = 0u;
    USBMIDI_1_lastPacketSize  = 0u;

    /* Enable component interrupts. */
#if (CY_PSOC4)
    CyIntEnable(USBMIDI_1_INTR_HI_VECT_NUM);
    CyIntEnable(USBMIDI_1_INTR_MED_VECT_NUM);
    CyIntEnable(USBMIDI_1_INTR_LO_VECT_NUM);
#else
    CyIntEnable(USBMIDI_1_BUS_RESET_VECT_NUM);
    CyIntEnable(USBMIDI_1_EP_0_VECT_NUM);

    #if (USBMIDI_1_SOF_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_SOF_VECT_NUM);
    #endif /* (USBMIDI_1_SOF_ISR_ACTIVE) */

    #if (USBMIDI_1_EP1_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_1_VECT_NUM);
    #endif /* (USBMIDI_1_EP1_ISR_ACTIVE) */

    #if (USBMIDI_1_EP2_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_2_VECT_NUM);
    #endif /* (USBMIDI_1_EP5_ISR_ACTIVE) */

    #if (USBMIDI_1_EP3_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_3_VECT_NUM);
    #endif /* (USBMIDI_1_EP5_ISR_ACTIVE) */

    #if (USBMIDI_1_EP4_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_4_VECT_NUM);
    #endif /* (USBMIDI_1_EP5_ISR_ACTIVE) */

    #if (USBMIDI_1_EP5_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_5_VECT_NUM);
    #endif /* (USBMIDI_1_EP5_ISR_ACTIVE) */

    #if (USBMIDI_1_EP6_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_6_VECT_NUM);
    #endif /* USBMIDI_1_EP6_ISR_REMOVE */

    #if (USBMIDI_1_EP7_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_7_VECT_NUM);
    #endif /* (USBMIDI_1_EP7_ISR_ACTIVE) */

    #if (USBMIDI_1_EP8_ISR_ACTIVE)
        CyIntEnable(USBMIDI_1_EP_8_VECT_NUM);
    #endif /* (USBMIDI_1_EP8_ISR_ACTIVE) */
#endif /* (CY_PSOC4) */
    ...
    USBMIDI_1_ARB_INT_EN_REG = USBMIDI_1_DEFAULT_ARB_INT_EN;
        ...
        CyIntEnable(USBMIDI_1_ARB_VECT_NUM);
    ...
    USBMIDI_1_ARB_CFG_REG = USBMIDI_1_DEFAULT_ARB_CFG;
        ...
        CyDmaEnable();
            ...
            /* Change DMA priority to be highest. */
             CyIntSetPriority(CYDMA_INTR_NUMBER, USBMIDI_1_DMA_AUTO_INTR_PRIO);
        #endif /* (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO) */
    #endif /* (CY_PSOC4) */
            ...
            CyIntEnable(CYDMA_INTR_NUMBER);
                ...
                USBMIDI_1_EP_DMA_Done_isr_StartEx(&USBMIDI_1_EP_DMA_DONE_ISR);
                USBMIDI_1_EP17_DMA_Done_SR_InterruptEnable();
                USBMIDI_1_EP8_DMA_Done_SR_InterruptEnable();
            #endif /* (USBMIDI_1_EP_DMA_AUTO_OPT == 0u) */
        #endif /* (CY_PSOC4) */
    #endif /* (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO) */
#endif /* (USBMIDI_1_EP_MANAGEMENT_DMA) */
...
/*******************************************************************************
* Function Name: USBMIDI_1_ReInitComponent
****************************************************************************//**
*
...
*
* \globalvars
*   USBMIDI_1_device - Contains the device number of the desired Device
...
*   USBMIDI_1_lastPacketSize - Initialized to 0;
*
* \reentrant
*  No.
*
...
*   \ref USBMIDI_1_deviceStatus
*
*   \ref USBMIDI_1_configurationChanged
*
*   USBMIDI_1_intiVar -  This variable is set to zero
*
*******************************************************************************/
void USBMIDI_1_Stop(void) 
{
    ...
    /* Disable D+ pull-up. */
    USBMIDI_1_USBIO_CR1_REG &= (uint8) ~ USBMIDI_1_USBIO_CR1_USBPUEN;

#if (CY_PSOC4)
    /* Disable USBFS block. */
    USBMIDI_1_POWER_CTRL_REG &= (uint32) ~USBMIDI_1_POWER_CTRL_ENABLE;
#else
...
#if (CY_PSOC4)
    CyIntDisable(USBMIDI_1_INTR_HI_VECT_NUM);
    CyIntDisable(USBMIDI_1_INTR_LO_VECT_NUM);
    CyIntDisable(USBMIDI_1_INTR_MED_VECT_NUM);
#else

    CyIntDisable(USBMIDI_1_BUS_RESET_VECT_NUM);
    CyIntDisable(USBMIDI_1_EP_0_VECT_NUM);

    #if (USBMIDI_1_SOF_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_SOF_VECT_NUM);
    #endif /* (USBMIDI_1_SOF_ISR_ACTIVE) */

    #if (USBMIDI_1_EP1_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_1_VECT_NUM);
    #endif /* (USBMIDI_1_EP1_ISR_ACTIVE) */

    #if (USBMIDI_1_EP2_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_2_VECT_NUM);
    #endif /* (USBMIDI_1_EP2_ISR_ACTIVE) */

    #if (USBMIDI_1_EP3_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_3_VECT_NUM);
    #endif /* (USBMIDI_1_EP3_ISR_ACTIVE) */

    #if (USBMIDI_1_EP4_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_4_VECT_NUM);
    #endif /* (USBMIDI_1_EP4_ISR_ACTIVE) */

    #if (USBMIDI_1_EP5_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_5_VECT_NUM);
    #endif /* (USBMIDI_1_EP5_ISR_ACTIVE) */

    #if (USBMIDI_1_EP6_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_6_VECT_NUM);
    #endif /* USBMIDI_1_EP6_ISR_REMOVE */

    #if (USBMIDI_1_EP7_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_7_VECT_NUM);
    #endif /* (USBMIDI_1_EP7_ISR_ACTIVE) */

    #if (USBMIDI_1_EP8_ISR_ACTIVE)
        CyIntDisable(USBMIDI_1_EP_8_VECT_NUM);
    #endif /* (USBMIDI_1_EP8_ISR_ACTIVE) */
    ...
    USBMIDI_1_initVar = 0u;
}


/*******************************************************************************
* Function Name: USBMIDI_1_CheckActivity
****************************************************************************//**
*
...
{
    uint8 cr1Reg = USBMIDI_1_CR1_REG;

    /* Clear bus activity. */
    USBMIDI_1_CR1_REG = (cr1Reg & (uint8) ~USBMIDI_1_CR1_BUS_ACTIVITY);

    /* Get bus activity. */
    return ((0u != (cr1Reg & USBMIDI_1_CR1_BUS_ACTIVITY)) ? (1u) : (0u));
}


/*******************************************************************************
* Function Name: USBMIDI_1_GetConfiguration
****************************************************************************//**
*
...
{
    return (USBMIDI_1_configuration);
}


/*******************************************************************************
* Function Name: USBMIDI_1_IsConfigurationChanged
****************************************************************************//**
*
...
* \globalvars
*
*  \ref USBMIDI_1_configurationChanged - This variable is set to 1 after
...
uint8 USBMIDI_1_IsConfigurationChanged(void) 
{
    ...
    if (USBMIDI_1_configurationChanged != 0u)
    {
        res = USBMIDI_1_configurationChanged;
        USBMIDI_1_configurationChanged = 0u;
    }
...
/*******************************************************************************
* Function Name: USBMIDI_1_GetInterfaceSetting
****************************************************************************//**
*
...
{
    return (USBMIDI_1_interfaceSetting[interfaceNumber]);
}


/*******************************************************************************
* Function Name: USBMIDI_1_GetEPState
****************************************************************************//**
*
...
{
    return (USBMIDI_1_EP[epNumber].apiEpState);
}


/*******************************************************************************
* Function Name: USBMIDI_1_GetEPCount
****************************************************************************//**
*
...
uint16 USBMIDI_1_GetEPCount(uint8 epNumber) 
{
    ...
    if ((epNumber > USBMIDI_1_EP0) && (epNumber < USBMIDI_1_MAX_EP))
    {
        ...
        cntr  = ((uint16) USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCnt0) & USBMIDI_1_EPX_CNT0_MASK;
        cntr  = ((uint16) (cntr << 8u)) | ((uint16) USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCnt1);
        cntr -= USBMIDI_1_EPX_CNTX_CRC_COUNT;
    }
...
#if (CY_PSOC4)
    /*******************************************************************************
    * Function Name: USBMIDI_1_InitEpDma
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    static void USBMIDI_1_InitEpDma(void)
    {
        ...
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep1_dma_CHANNEL] = USBMIDI_1_ep1_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA1_ACTIVE) */

    #if (USBMIDI_1_DMA2_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep2_dma_CHANNEL] = USBMIDI_1_ep2_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA2_ACTIVE) */

    #if (USBMIDI_1_DMA3_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep3_dma_CHANNEL] = USBMIDI_1_ep3_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA3_ACTIVE) */

    #if (USBMIDI_1_DMA4_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep4_dma_CHANNEL] = USBMIDI_1_ep4_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA4_ACTIVE) */

    #if (USBMIDI_1_DMA5_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep5_dma_CHANNEL] = USBMIDI_1_ep5_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA5_ACTIVE) */

    #if (USBMIDI_1_DMA6_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep6_dma_CHANNEL] = USBMIDI_1_ep6_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA6_ACTIVE) */

    #if (USBMIDI_1_DMA7_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep7_dma_CHANNEL] = USBMIDI_1_ep7_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA7_ACTIVE) */

    #if (USBMIDI_1_DMA8_ACTIVE)
        CYDMA_CH_CTL_BASE.ctl[USBMIDI_1_ep8_dma_CHANNEL] = USBMIDI_1_ep8_dma_CHANNEL_CFG;
    #endif /* (USBMIDI_1_DMA8_ACTIVE) */

    #if (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO)
        /* Initialize DMA channel callbacks. */
        #if (USBMIDI_1_DMA1_ACTIVE)
            (void) USBMIDI_1_ep1_dma_SetInterruptCallback(&USBMIDI_1_EP1_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA1_ACTIVE) */

        #if (USBMIDI_1_DMA2_ACTIVE)
            (void) USBMIDI_1_ep2_dma_SetInterruptCallback(&USBMIDI_1_EP2_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA2_ACTIVE) */

        #if (USBMIDI_1_DMA3_ACTIVE)
            (void) USBMIDI_1_ep3_dma_SetInterruptCallback(&USBMIDI_1_EP3_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA3_ACTIVE) */

        #if (USBMIDI_1_DMA4_ACTIVE)
            (void) USBMIDI_1_ep4_dma_SetInterruptCallback(&USBMIDI_1_EP4_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA4_ACTIVE) */

        #if (USBMIDI_1_DMA5_ACTIVE)
            (void) USBMIDI_1_ep5_dma_SetInterruptCallback(&USBMIDI_1_EP5_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA5_ACTIVE) */

        #if (USBMIDI_1_DMA6_ACTIVE)
            (void) USBMIDI_1_ep6_dma_SetInterruptCallback(&USBMIDI_1_EP6_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA6_ACTIVE) */

        #if (USBMIDI_1_DMA7_ACTIVE)
            (void) USBMIDI_1_ep7_dma_SetInterruptCallback(&USBMIDI_1_EP7_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA7_ACTIVE) */

        #if (USBMIDI_1_DMA8_ACTIVE)
            (void) USBMIDI_1_ep8_dma_SetInterruptCallback(&USBMIDI_1_EP8_DMA_DONE_ISR);
        #endif /* (USBMIDI_1_DMA8_ACTIVE) */
    #endif /* (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO) */
    }
#else
    ...
    /***************************************************************************
    * Function Name: USBMIDI_1_InitEP_DMA
    ************************************************************************//**
    *
    *  This function allocates and initializes a DMA channel to be used by the
    *  USBMIDI_1_LoadInEP() or USBMIDI_1_ReadOutEP() APIs for data
    ...
    ***************************************************************************/
                                                                    ...
                                                                    
    {
    ...
    #if (USBMIDI_1_DMA1_ACTIVE)
        case USBMIDI_1_EP1:
            USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep1_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                    USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA1_ACTIVE) */

    #if (USBMIDI_1_DMA2_ACTIVE)
        case USBMIDI_1_EP2:
            USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep2_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                    USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA2_ACTIVE) */
    ...
    #if (USBMIDI_1_DMA3_ACTIVE)
            case USBMIDI_1_EP3:
                USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep3_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                        USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA3_ACTIVE) */
    ...
    #if (USBMIDI_1_DMA4_ACTIVE)
            case USBMIDI_1_EP4:
                USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep4_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                        USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA4_ACTIVE) */
    ...
    #if (USBMIDI_1_DMA5_ACTIVE)
            case USBMIDI_1_EP5:
                USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep5_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                        USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA5_ACTIVE) */
    ...
    #if (USBMIDI_1_DMA6_ACTIVE)
        case USBMIDI_1_EP6:
            USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep6_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                    USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA6_ACTIVE) */
    ...
    #if (USBMIDI_1_DMA7_ACTIVE)
        case USBMIDI_1_EP7:
                USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep7_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                        USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA7_ACTIVE) */
    ...
    #if (USBMIDI_1_DMA8_ACTIVE)
        case USBMIDI_1_EP8:
                USBMIDI_1_DmaChan[epNumber] = USBMIDI_1_ep8_DmaInitialize(USBMIDI_1_DMA_BYTES_PER_BURST,
                                                                                        USBMIDI_1_DMA_REQUEST_PER_BURST, src, dst);
            break;
    #endif /* (USBMIDI_1_DMA8_ACTIVE) */
        ...
        if ((epNumber > USBMIDI_1_EP0) && (epNumber < USBMIDI_1_MAX_EP))
        {
            USBMIDI_1_DmaTd[epNumber] = CyDmaTdAllocate();

        #if (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u))
            USBMIDI_1_DmaNextTd[epNumber] = CyDmaTdAllocate();
        #endif /* (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u)) */
        }
    }
#endif /* (CY_PSOC4) */
    ...
    /***************************************************************************
    * Function Name: USBMIDI_1_Stop_DMA
    ************************************************************************//**
    *  
    ...
    *  to trigger DMA re-configuration when USBMIDI_1_LoadInEP() or 
    *  USBMIDI_1_ReadOutEP() functions are called the first time. 
    *  
    ...
    ***************************************************************************/
    void USBMIDI_1_Stop_DMA(uint8 epNumber) 
    {
        ...
        i = (epNumber < USBMIDI_1_MAX_EP) ? epNumber : USBMIDI_1_EP1;

        do
        {
        #if (CY_PSOC4)
            if (0u != USBMIDI_1_DmaChan[i])
            {
                USBMIDI_1_CyDmaChDisable(USBMIDI_1_DmaChan[i]);
            }
        #else
            if(USBMIDI_1_DmaTd[i] != DMA_INVALID_TD)
            {
                (void) CyDmaChDisable(USBMIDI_1_DmaChan[i]);
                CyDmaTdFree(USBMIDI_1_DmaTd[i]);
                USBMIDI_1_DmaTd[i] = DMA_INVALID_TD;
            }

            #if (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u))
                if(USBMIDI_1_DmaNextTd[i] != DMA_INVALID_TD)
                {
                    CyDmaTdFree(USBMIDI_1_DmaNextTd[i]);
                    USBMIDI_1_DmaNextTd[i] = DMA_INVALID_TD;
                }
            #endif /* (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u)) */
        ...
        while ((i < USBMIDI_1_MAX_EP) && (epNumber == USBMIDI_1_MAX_EP));
    }
#endif /* (USBMIDI_1_EP_MANAGEMENT_DMA) */
...
#if (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u))
    /***************************************************************************
    * Function Name: USBMIDI_1_LoadNextInEP
    ************************************************************************//**
    *
    * Summary:
    ...
    ***************************************************************************/
    void USBMIDI_1_LoadNextInEP(uint8 epNumber, uint8 mode) 
    {
        ...
        if (mode == 0u)
        {
            ...
            convert = (reg16 *) &CY_DMA_TDMEM_STRUCT_PTR[USBMIDI_1_DmaTd[epNumber]].TD0[0u];
            /* Set transfer length. */
            CY_SET_REG16(convert, USBMIDI_1_inLength[epNumber] - USBMIDI_1_DMA_BYTES_PER_BURST);
            /* CyDmaTdSetAddress API is optimized to change source address only. */
            convert = (reg16 *) &CY_DMA_TDMEM_STRUCT_PTR[USBMIDI_1_DmaTd[epNumber]].TD1[0u];
            CY_SET_REG16(convert, LO16((uint32)USBMIDI_1_inDataPointer[epNumber] +
                                            USBMIDI_1_DMA_BYTES_PER_BURST));
            USBMIDI_1_inBufFull[epNumber] = 1u;
        }
        else
        {
            ...
            convert = (reg16 *) &CY_DMA_TDMEM_STRUCT_PTR[USBMIDI_1_DmaTd[epNumber]].TD0[0u];
            /* Set transfer length. */
            CY_SET_REG16(convert, USBMIDI_1_DMA_BYTES_REPEAT);
            /* CyDmaTdSetAddress API is optimized to change source address only. */
            convert = (reg16 *) &CY_DMA_TDMEM_STRUCT_PTR[USBMIDI_1_DmaTd[epNumber]].TD1[0u];
            CY_SET_REG16(convert,  LO16((uint32)USBMIDI_1_inDataPointer[epNumber] +
                                   (USBMIDI_1_DMA_BYTES_PER_BURST - USBMIDI_1_DMA_BYTES_REPEAT)));
        }

        /* CyDmaChSetInitialTd API is optimized to initialize TD. */
        CY_DMA_CH_STRUCT_PTR[USBMIDI_1_DmaChan[epNumber]].basic_status[1u] = USBMIDI_1_DmaTd[epNumber];
    }
#endif /* (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO && (USBMIDI_1_EP_DMA_AUTO_OPT == 0u)) */
#endif /* (CY_PSOC3 || CY_PSOC5) */
...
/*******************************************************************************
* Function Name: USBMIDI_1_LoadInEP
****************************************************************************//**
*
                                                                        ...
                                                                        
{
    if ((epNumber > USBMIDI_1_EP0) && (epNumber < USBMIDI_1_MAX_EP))
    {
        ...
        if (length > (USBMIDI_1_EPX_DATA_BUF_MAX - USBMIDI_1_EP[epNumber].buffOffset))
        {
            length = USBMIDI_1_EPX_DATA_BUF_MAX - USBMIDI_1_EP[epNumber].buffOffset;
        }
    #endif /* (!USBMIDI_1_EP_MANAGEMENT_DMA_AUTO) */

        /* Set count and data toggle. */
        USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCnt0 = (uint8) HI8(length) | USBMIDI_1_EP[epNumber].epToggle;
        USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCnt1 = (uint8) LO8(length);
        ...
        if (NULL != pData)
        {
            ...
            for (i = 0u; i < length; ++i)
            {
                USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr = pData[i];
            }
        }

        /* IN endpoint buffer is full - read to be read. */
        USBMIDI_1_EP[epNumber].apiEpState = USBMIDI_1_NO_EVENT_PENDING;

        /* Arm IN endpoint. */
        USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCr0 = USBMIDI_1_EP[epNumber].epMode;

    #else

        #if (CY_PSOC3 || CY_PSOC5LP)
            /* Initialize DMA if it was not initialized. */
            if (DMA_INVALID_TD == USBMIDI_1_DmaTd[epNumber])
            {
                USBMIDI_1_InitEP_DMA(epNumber, pData);
            }
            ...
            {
            #if (CY_PSOC4)
                uint32 channelNum = (uint32) USBMIDI_1_DmaChan[epNumber];

                /* Disable DMA channel: start configuration. */
                USBMIDI_1_CyDmaChDisable(channelNum);

                /* Configure source and destination. */
                USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) pData);
                USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr);

                /* Configure DMA descriptor. */
                --length;
                USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR0, USBMIDI_1_DMA_COMMON_CFG | length |
                ...
                (void) CyDmaChDisable(USBMIDI_1_DmaChan[epNumber]);
                (void) CyDmaTdSetConfiguration(USBMIDI_1_DmaTd[epNumber], length, CY_DMA_DISABLE_TD, TD_TERMIN_EN | TD_INC_SRC_ADR);
                (void) CyDmaTdSetAddress(USBMIDI_1_DmaTd[epNumber], LO16((uint32) pData), LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr));

                /* Enable DMA channel. */
                (void) CyDmaChSetInitialTd(USBMIDI_1_DmaChan[epNumber], USBMIDI_1_DmaTd[epNumber]);
                (void) CyDmaChEnable(USBMIDI_1_DmaChan[epNumber], 1u);
            #endif /* (CY_PSOC4) */

                /* Generate DMA request. */
                USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].epCfg |=  (uint8)  USBMIDI_1_ARB_EPX_CFG_DMA_REQ;
                USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].epCfg &=  (uint8) ~USBMIDI_1_ARB_EPX_CFG_DMA_REQ;
            ...
            if (pData != NULL)
            {
                ...
                USBMIDI_1_DmaEpBufferAddrBackup[epNumber] = (uint32) pData;
                ...
                USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr);
                USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR1, (void*) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr);

                /* Configure DMA descriptor. */
                USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR0, USBMIDI_1_DMA_COMMON_CFG  |
                                                        CYDMA_BYTE | CYDMA_ELEMENT_WORD | CYDMA_INC_SRC_ADDR | CYDMA_INVALIDATE | CYDMA_CHAIN);

                /* Configure DMA descriptor. */
                USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR1, USBMIDI_1_DMA_COMMON_CFG  |
                                                        CYDMA_BYTE | CYDMA_ELEMENT_WORD | CYDMA_INC_SRC_ADDR | CYDMA_INVALIDATE | CYDMA_CHAIN);

                /* Enable interrupt from DMA channel. */
                USBMIDI_1_CyDmaSetInterruptMask(channelNum);
                ...
                (void) CyDmaChDisable(USBMIDI_1_DmaChan[epNumber]);
                ...
                #if (USBMIDI_1_EP_DMA_AUTO_OPT == 0u)
                    USBMIDI_1_inLength[epNumber] = length;
                    USBMIDI_1_inDataPointer[epNumber] = pData;

                    /* Configure DMA to send data only for first burst */
                    (void) CyDmaTdSetConfiguration(USBMIDI_1_DmaTd[epNumber],
                        (length > USBMIDI_1_DMA_BYTES_PER_BURST) ? USBMIDI_1_DMA_BYTES_PER_BURST : length,
                        USBMIDI_1_DmaNextTd[epNumber], TD_TERMIN_EN | TD_INC_SRC_ADR);
                    (void) CyDmaTdSetAddress(USBMIDI_1_DmaTd[epNumber], LO16((uint32) pData),
                                                                               LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr));
                    ...
                    */
                    (void) CyDmaTdSetConfiguration(USBMIDI_1_DmaNextTd[epNumber], 1u,
                                                   USBMIDI_1_DmaNextTd[epNumber],
                                                   USBMIDI_1_epX_TD_TERMOUT_EN[epNumber]);

                    /* Configure DmaNextTd to clear Data Ready status. */
                    (void) CyDmaTdSetAddress(USBMIDI_1_DmaNextTd[epNumber], LO16((uint32) &clearInDataRdyStatus),
                                                                                   LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].epCfg));
                #else
                    /* Configure DMA to send all data. */
                    (void) CyDmaTdSetConfiguration(USBMIDI_1_DmaTd[epNumber], length,
                                                   USBMIDI_1_DmaTd[epNumber], TD_TERMIN_EN | TD_INC_SRC_ADR);
                    (void) CyDmaTdSetAddress(USBMIDI_1_DmaTd[epNumber], LO16((uint32) pData),
                                                                               LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr));
                #endif /* (USBMIDI_1_EP_DMA_AUTO_OPT == 0u) */

                /* Clear any potential pending DMA requests before starting DMA channel to transfer data. */
                (void) CyDmaClearPendingDrq(USBMIDI_1_DmaChan[epNumber]);
                /* Enable DMA. */
                (void) CyDmaChSetInitialTd(USBMIDI_1_DmaChan[epNumber], USBMIDI_1_DmaTd[epNumber]);
                (void) CyDmaChEnable(USBMIDI_1_DmaChan[epNumber], 1u);
            #endif /* (CY_PSOC4) */
            ...
            else
            {
                ...
                if (length > 0u)
                {
                    ...
                    USBMIDI_1_DmaEpBurstCnt[epNumber] = (uint8) (length / USBMIDI_1_DMA_BYTES_PER_BURST);

                    /* Get number of elements in the last burst. */
                    USBMIDI_1_DmaEpLastBurstEl[epNumber] = (uint8) (length % USBMIDI_1_DMA_BYTES_PER_BURST);

                    /* Get total number of bursts. */
                    USBMIDI_1_DmaEpBurstCnt[epNumber] += (0u != USBMIDI_1_DmaEpLastBurstEl[epNumber]) ? 1u : 0u;

                    /* Adjust number of data elements transferred in last burst. */
                    USBMIDI_1_DmaEpLastBurstEl[epNumber] = (0u != USBMIDI_1_DmaEpLastBurstEl[epNumber]) ?
                                                                          (USBMIDI_1_DmaEpLastBurstEl[epNumber] - 1u) :
                                                                          (USBMIDI_1_DMA_BYTES_PER_BURST - 1u);

                    /* Get number of data elements to transfer for descriptor 0 and 1. */
                    lengthDescr0 = (1u == USBMIDI_1_DmaEpBurstCnt[epNumber]) ? USBMIDI_1_DmaEpLastBurstEl[epNumber] : (USBMIDI_1_DMA_BYTES_PER_BURST - 1u);
                    lengthDescr1 = (2u == USBMIDI_1_DmaEpBurstCnt[epNumber]) ? USBMIDI_1_DmaEpLastBurstEl[epNumber] : (USBMIDI_1_DMA_BYTES_PER_BURST - 1u);


                    /* Mark which descriptor is last one to execute. */
                    USBMIDI_1_DmaEpLastBurstEl[epNumber] |= (0u != (USBMIDI_1_DmaEpBurstCnt[epNumber] & 0x1u)) ?
                                                                            USBMIDI_1_DMA_DESCR0_MASK : USBMIDI_1_DMA_DESCR1_MASK;

                    /* Restore DMA settings for current transfer. */
                    USBMIDI_1_CyDmaChDisable(channelNum);

                    /* Restore destination address for input endpoint. */
                    USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) ((uint32) USBMIDI_1_DmaEpBufferAddrBackup[epNumber]));
                    USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR1, (void*) ((uint32) USBMIDI_1_DmaEpBufferAddrBackup[epNumber] +
                                                                                                                   USBMIDI_1_DMA_BYTES_PER_BURST));

                    /* Set number of elements to transfer. */
                    USBMIDI_1_CyDmaSetNumDataElements(channelNum, USBMIDI_1_DMA_DESCR0, lengthDescr0);
                    USBMIDI_1_CyDmaSetNumDataElements(channelNum, USBMIDI_1_DMA_DESCR1, lengthDescr1);
                    ...
                    if (USBMIDI_1_DmaEpBurstCnt[epNumber] > 1u)
                    {
                    ...
                    USBMIDI_1_DmaEpBurstCnt[epNumber] = USBMIDI_1_DMA_GET_BURST_CNT(USBMIDI_1_DmaEpBurstCnt[epNumber]);

                    /* Enable DMA channel: configuration complete. */
                    USBMIDI_1_CyDmaChEnable(channelNum);

                #elif (USBMIDI_1_EP_DMA_AUTO_OPT == 0u)
                    USBMIDI_1_inLength[epNumber]  = length;
                    USBMIDI_1_inBufFull[epNumber] = 0u;

                    (void) CyDmaChDisable(USBMIDI_1_DmaChan[epNumber]);
                    /* Configure DMA to send data only for first burst. */
                    (void) CyDmaTdSetConfiguration(
                        USBMIDI_1_DmaTd[epNumber], (length > USBMIDI_1_DMA_BYTES_PER_BURST) ?
                        USBMIDI_1_DMA_BYTES_PER_BURST : length,
                        USBMIDI_1_DmaNextTd[epNumber], TD_TERMIN_EN | TD_INC_SRC_ADR );
                    (void) CyDmaTdSetAddress(USBMIDI_1_DmaTd[epNumber], LO16((uint32)  USBMIDI_1_inDataPointer[epNumber]),
                                                                               LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr));
                    /* Clear Any potential pending DMA requests before starting DMA channel to transfer data. */
                    (void) CyDmaClearPendingDrq(USBMIDI_1_DmaChan[epNumber]);
                    /* Enable DMA. */
                ...
                #if !defined (USBMIDI_1_MANUAL_IN_EP_ARM)
                    /* Set IN data ready to generate DMA request to load data into endpoint buffer. */
                    USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].epCfg |= USBMIDI_1_ARB_EPX_CFG_IN_DATA_RDY;
                #endif  /* (USBMIDI_1_MANUAL_IN_EP_ARM) */
...
/*******************************************************************************
* Function Name: USBMIDI_1_ReadOutEP
****************************************************************************//**
*
*   This function performs different functionality depending on the Component’s
...
*   transfer after calling the USBMIDI_1_ReadOutEP() API. For example,
*   by checking EPstate:
*
...
{
    if ((pData != NULL) && (epNumber > USBMIDI_1_EP0) && (epNumber < USBMIDI_1_MAX_EP))
    {
    #if (!USBMIDI_1_EP_MANAGEMENT_DMA_AUTO)
        /* Adjust requested length to available data. */
        length = (length > USBMIDI_1_GetEPCount(epNumber)) ? USBMIDI_1_GetEPCount(epNumber) : length;
    #endif /* (!USBMIDI_1_EP_MANAGEMENT_DMA_AUTO) */
    ...
    #if (USBMIDI_1_EP_MANAGEMENT_MANUAL)
        {
            ...
            for (i = 0u; i < length; ++i)
            {
                pData[i] = (uint8) USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr;
            }
        }

        /* Arm OUT endpoint after data has been copied from endpoint buffer. */
        USBMIDI_1_EnableOutEP(epNumber);
    #else
        ...
        #if (CY_PSOC4)
        {
            ...
            /* Configure source and destination. */
            USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr);
            USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) pData);

            /* Configure DMA descriptor. */
            USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR0, USBMIDI_1_DMA_COMMON_CFG | (uint16)(length - 1u) |
            ...
            /* Configure DMA to transfer data. */
            (void) CyDmaChDisable(USBMIDI_1_DmaChan[epNumber]);
            (void) CyDmaTdSetConfiguration(USBMIDI_1_DmaTd[epNumber], length, CY_DMA_DISABLE_TD, TD_TERMIN_EN | TD_INC_DST_ADR);
            (void) CyDmaTdSetAddress(USBMIDI_1_DmaTd[epNumber], LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr), LO16((uint32)pData));
        ...
        #if (CY_PSOC4)
        {
            ...
            USBMIDI_1_DmaEpLastBurstEl[epNumber] |= (USBMIDI_1_DmaEpBurstCnt[epNumber] > 2u) ? USBMIDI_1_DMA_DESCR_REVERT : 0u;
            ...
            USBMIDI_1_DmaEpBufferAddrBackup[epNumber] = (uint32) pData;
            USBMIDI_1_DmaEpBurstCntBackup[epNumber]   = USBMIDI_1_DmaEpBurstCnt[epNumber];
            ...
            /* Set destination address. */
            USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr);
            USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR1, (void*) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr);

            USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) ((uint32) pData));
            USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR1, (void*) ((uint32) pData + USBMIDI_1_DMA_BYTES_PER_BURST));

            /* Configure DMA descriptor. */
            USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR0, USBMIDI_1_DMA_COMMON_CFG  | lengthDescr0 |
                                                    CYDMA_BYTE | CYDMA_WORD_ELEMENT | CYDMA_INC_DST_ADDR | CYDMA_INVALIDATE | CYDMA_CHAIN);

            /* Configure DMA descriptor. */
            USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR1, USBMIDI_1_DMA_COMMON_CFG  | lengthDescr1 |
                                                    CYDMA_BYTE | CYDMA_WORD_ELEMENT | CYDMA_INC_DST_ADDR | CYDMA_INVALIDATE | CYDMA_CHAIN);
            ...
            if (USBMIDI_1_DmaEpBurstCntBackup[epNumber] > 1u)
            {
                USBMIDI_1_CyDmaValidateDescriptor(channelNum, USBMIDI_1_DMA_DESCR1);
            }
        ...
        #else
            (void) CyDmaChDisable(USBMIDI_1_DmaChan[epNumber]);
            (void) CyDmaTdSetConfiguration(USBMIDI_1_DmaTd[epNumber], length,  USBMIDI_1_DmaTd[epNumber], TD_TERMIN_EN | TD_INC_DST_ADR);
            (void) CyDmaTdSetAddress(USBMIDI_1_DmaTd[epNumber], LO16((uint32) &USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].rwDr), LO16((uint32) pData));
...
/*******************************************************************************
* Function Name: USBMIDI_1_LoadInEP16
****************************************************************************//**
*
*  This function performs different functionality depending on the Component’s
*  configured Endpoint Buffer Management. This parameter is defined in
...
void USBMIDI_1_LoadInEP16(uint8 epNumber, const uint8 pData[], uint16 length)
{
    ...
    if ((epNumber > USBMIDI_1_EP0) && (epNumber < USBMIDI_1_MAX_EP))
    {
        ...
        /* Set count and data toggle. */
        USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCnt0 = (uint32) HI8(length) | USBMIDI_1_EP[epNumber].epToggle;
        USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCnt1 = (uint32) LO8(length);
        ...
        if (NULL != pData)
        {
            ...
            {
                USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16 = dataBuf[i];
            }
        }
        ...
        USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCr0 = USBMIDI_1_EP[epNumber].epMode;
            ...
            if ((pData != NULL) && (length > 0u))
            {
                ...
                /* Configure source and destination. */
                USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) pData);
                USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16);
                ...
                /* Generate DMA request. */
                USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].epCfg |=  (uint32)  USBMIDI_1_ARB_EPX_CFG_DMA_REQ;
                USBMIDI_1_ARB_EP_BASE.arbEp[epNumber].epCfg &=  (uint32) ~USBMIDI_1_ARB_EPX_CFG_DMA_REQ;
            ...
            if (pData != NULL)
            {
                ...
                /* Set destination address. */
                USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16);
                USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR1, (void*) &USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16);
            ...
            else
            {
                ...
                if (length > 0u)
                {
                    ...
                    /* Adjust number of data elements transferred in last burst. */
                    USBMIDI_1_DmaEpLastBurstEl[epNumber] = (0u != USBMIDI_1_DmaEpLastBurstEl[epNumber]) ?
                                                                          ((USBMIDI_1_DmaEpLastBurstEl[epNumber] >> 1u) - 1u) :
                                                                           (USBMIDI_1_DMA_HALFWORDS_PER_BURST - 1u);

                    /* Get number of data elements to transfer for descriptor 0 and 1. */
                    lengthDescr0 = (1u == USBMIDI_1_DmaEpBurstCnt[epNumber]) ? USBMIDI_1_DmaEpLastBurstEl[epNumber] : (USBMIDI_1_DMA_HALFWORDS_PER_BURST - 1u);
                    lengthDescr1 = (2u == USBMIDI_1_DmaEpBurstCnt[epNumber]) ? USBMIDI_1_DmaEpLastBurstEl[epNumber] : (USBMIDI_1_DMA_HALFWORDS_PER_BURST - 1u);
...
/*******************************************************************************
* Function Name: USBMIDI_1_ReadOutEP16
****************************************************************************//**
*
*   This function performs different functionality depending on the Component’s
*   configured Endpoint Buffer Management. This parameter is defined in the
...
uint16 USBMIDI_1_ReadOutEP16(uint8 epNumber, uint8 pData[], uint16 length)
{
    ...
    adjLength =  length + ((uint32)length & 1u);
    ...
    #if (USBMIDI_1_EP_MANAGEMENT_MANUAL)
        {
            ...
            {
                dataBuf[i] = (uint16) USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16;
            }
        }
        ...
        #if (USBMIDI_1_EP_MANAGEMENT_DMA_MANUAL)
        {
            ...
            /* Configure source and destination. */
            USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16);
            USBMIDI_1_CyDmaSetDstAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) pData);

            /* Configure DMA descriptor. */
            USBMIDI_1_CyDmaSetConfiguration(channelNum, USBMIDI_1_DMA_DESCR0, USBMIDI_1_DMA_COMMON_CFG | (uint16)((adjLength >> 1u) - 1u) |
        ...
        #if (USBMIDI_1_EP_MANAGEMENT_DMA_AUTO)
        {
            ...
            /* Get number of full bursts. */
            USBMIDI_1_DmaEpBurstCnt[epNumber] = (uint8) (adjLength / USBMIDI_1_DMA_BYTES_PER_BURST);

            /* Get number of elements in last burst. */
            USBMIDI_1_DmaEpLastBurstEl[epNumber] = (uint8) (adjLength % USBMIDI_1_DMA_BYTES_PER_BURST);
            ...
            USBMIDI_1_DmaEpLastBurstEl[epNumber] |= USBMIDI_1_DMA_DESCR_16BITS;
            ...
            /* Set destination address. */
            USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR0, (void*) &USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16);
            USBMIDI_1_CyDmaSetSrcAddress(channelNum, USBMIDI_1_DMA_DESCR1, (void*) &USBMIDI_1_ARB_EP16_BASE.arbEp[epNumber].rwDr16);
...
/*******************************************************************************
* Function Name: USBMIDI_1_EnableOutEP
****************************************************************************//**
*
...
* \globalvars
*
*  \ref USBMIDI_1_EP[epNumber].apiEpState - set to NO_EVENT_PENDING
*
* \reentrant
*  No.
*
...
/*******************************************************************************
* Function Name: USBMIDI_1_DisableOutEP
****************************************************************************//**
*
...
*    State                      |Description
*    ---------------------------|----------------------------------------------
*    USBMIDI_1_FORCE_J   | Force a J State onto the D+/D– lines
*    USBMIDI_1_FORCE_K   | Force a K State onto the D+/D– lines
*    USBMIDI_1_FORCE_SE0 | Force a Single Ended 0 onto the D+/D– lines
*    USBMIDI_1_FORCE_NONE| Return bus to SIE control
*
*
*******************************************************************************/
void USBMIDI_1_Force(uint8 bState) 
{
    ...
    */
    USBMIDI_1_USBIO_CR0_REG = bState;
}


/*******************************************************************************
* Function Name: USBMIDI_1_GetEPAckState
****************************************************************************//**
*
...
uint8 USBMIDI_1_GetEPAckState(uint8 epNumber) 
{
    ...
    if ((epNumber > USBMIDI_1_EP0) && (epNumber < USBMIDI_1_MAX_EP))
    {
        cr = USBMIDI_1_SIE_EP_BASE.sieEp[epNumber].epCr0 & USBMIDI_1_MODE_ACKD;
    }
...
/*******************************************************************************
* Function Name: USBMIDI_1_SetPowerStatus
****************************************************************************//**
*
...
*  --------------------------------------------|---------------------------
*  USBMIDI_1_DEVICE_STATUS_BUS_POWERED  | Set the device to bus powered
*  USBMIDI_1_DEVICE_STATUS_SELF_POWERED | Set the device to self powered
*
* \globalvars
*
*  \ref USBMIDI_1_deviceStatus - set power status
*
* \reentrant
*  No.
*
...
{
    if (powerStatus != USBMIDI_1_DEVICE_STATUS_BUS_POWERED)
    {
    ...
    /***************************************************************************
    * Function Name: USBMIDI_1_VBusPresent
    ************************************************************************//**
    *
    ...
    ***************************************************************************/
    ...
    {
        return ((0u != (USBMIDI_1_VBUS_STATUS_REG & USBMIDI_1_VBUS_VALID)) ? (uint8) 1u : (uint8) 0u);
    }
#endif /* (USBMIDI_1_VBUS_MONITORING_ENABLE) */


/*******************************************************************************
* Function Name: USBMIDI_1_RWUEnabled
****************************************************************************//**
*
...
*
* \globalvars
*  USBMIDI_1_deviceStatus - checked to determine remote status
*
*******************************************************************************/
uint8 USBMIDI_1_RWUEnabled(void) 
{
    uint8 result = USBMIDI_1_FALSE;

    if (0u != (USBMIDI_1_deviceStatus & USBMIDI_1_DEVICE_STATUS_REMOTE_WAKEUP))
    {
        result = USBMIDI_1_TRUE;
    }
...
/*******************************************************************************
* Function Name: USBMIDI_1_GetDeviceAddress
****************************************************************************//**
*
...
{
    return (uint8)(USBMIDI_1_CR0_REG & USBMIDI_1_CR0_DEVICE_ADDRESS_MASK);
}


/*******************************************************************************
* Function Name: USBMIDI_1_EnableSofInt
****************************************************************************//**
*
...
void USBMIDI_1_EnableSofInt(void) 
{
    ...
    USBMIDI_1_INTR_SIE_MASK_REG |= (uint32) USBMIDI_1_INTR_SIE_SOF_INTR;
#else
...
/*******************************************************************************
* Function Name: USBMIDI_1_DisableSofInt
****************************************************************************//**
*
...
void USBMIDI_1_DisableSofInt(void) 
{
    ...
    /***************************************************************************
    * Function Name: USBMIDI_1_DetectPortType
    ************************************************************************//**
    *
    ...
    *   Return Value                      |Description
    *   ----------------------------------|-------------------------------------
    *   USBMIDI_1_BCD_PORT_SDP     | Standard downstream port detected
    *   USBMIDI_1_BCD_PORT_CDP     | Charging downstream port detected
    *   USBMIDI_1_BCD_PORT_DCP     | Dedicated charging port detected
    *   USBMIDI_1_BCD_PORT_UNKNOWN | Unable to detect charging port type (proprietary charger type)
    *   USBMIDI_1_BCD_PORT_ERR     | Error condition in detection process
    *
    *
    * \sideeffects
    *
    ...
    ***************************************************************************/
    uint8 USBMIDI_1_Bcd_DetectPortType(void)
    {
        ...
        uint8 result = USBMIDI_1_BCD_PORT_UNKNOWN;
        ...
        */
        bkPwrCtrl = USBMIDI_1_POWER_CTRL_REG;
        USBMIDI_1_POWER_CTRL_REG = USBMIDI_1_DEFAULT_POWER_CTRL_VBUS\
                            & (~USBMIDI_1_POWER_CTRL_ENABLE_VBUS_PULLDOWN)\
                            & (~USBMIDI_1_POWER_CTRL_ENABLE_DM_PULLDOWN);


        /* Enable PHY detector and single-ended and differential receivers.
         * Enable charger detection.  */
        USBMIDI_1_POWER_CTRL_REG |= USBMIDI_1_DEFAULT_POWER_CTRL_PHY\
                                         | USBMIDI_1_POWER_CTRL_ENABLE_CHGDET;
        ...
        */
        #if defined (USBMIDI_1_NO_DCD)
        CyDelay(USBMIDI_1_BCD_TIMEOUT);
        #else
        /* DCD implementation:*/

        {
            uint16 timeout = USBMIDI_1_BCD_TIMEOUT;
            uint8 connectionApproved = 0u;
            uint8 connected = 0u;

            /*   BCD spec 1.2: Turns on Idp_src and D- pull-down resistor */
            USBMIDI_1_POWER_CTRL_REG |= USBMIDI_1_POWER_CTRL_ENABLE_DM_PULLDOWN;
            USBMIDI_1_CHGDET_CTRL_REG |= USBMIDI_1_CHGDET_CTRL_DCD_SRC_EN;

            /* BCD spec 1.2: Waits for D+ to be low for a time of Tdcd_dbnc*/
            while ((0u != timeout) && (0u == connectionApproved))
            {
                if (0u == (USBMIDI_1_USBIO_CR1_REG & USBMIDI_1_USBIO_CR1_DP0))
                {
                    connected++;
                }
                else
                ...
                connectionApproved = (USBMIDI_1_BCD_TDCD_DBNC < connected) ? 1u:0u;
                CyDelay(1u);
                timeout--;
            }
        ...
        #endif /*(USBMIDI_1_NO_DCD)*/

        /* Primary detection: enable VDP_SRC on D+ and IDM_SINK on D-. */
        USBMIDI_1_CHGDET_CTRL_REG = USBMIDI_1_CHGDET_CTRL_PRIMARY;
        CyDelay(USBMIDI_1_BCD_PRIMARY_WAIT);
        cr1RegVal = USBMIDI_1_USBIO_CR1_REG;

        /* Check is it SDP or DCP/CDP, read comparator 2 output. */
        if (0u == (USBMIDI_1_CHGDET_CTRL_REG & USBMIDI_1_CHGDET_CTRL_COMP_OUT))
        {
            /* Check status of D- line. */
            if (0u == (cr1RegVal & USBMIDI_1_USBIO_CR1_DM0))
            {
                result = USBMIDI_1_BCD_PORT_SDP;
            }
            else
            {
        ...
        {
            USBMIDI_1_CHGDET_CTRL_REG = USBMIDI_1_CHGDET_CTRL_DEFAULT \
                                                | USBMIDI_1_CHGDET_CTRL_SECONDARY;
            CyDelay(USBMIDI_1_BCD_SECONDARY_WAIT);
            cr1RegVal = USBMIDI_1_USBIO_CR1_REG;
            ...
            {
                /* Check status of D+ line. */
                if (0u == (cr1RegVal & USBMIDI_1_USBIO_CR1_DP0))
                {
                    result = USBMIDI_1_BCD_PORT_CDP;
                }
                else
                {
                    /* ERROR: such combination is impossible. Abort charger
            ...
            else
            {
                ...
                else
                {
                    ...
                    */
                    result = USBMIDI_1_BCD_PORT_UNKNOWN;
                }
            }
        }

        /* Restore CHGDET_CTRL. */
        USBMIDI_1_CHGDET_CTRL_REG = 0u;

        /*Revert registers back*/
        USBMIDI_1_POWER_CTRL_REG = bkPwrCtrl;
        USBMIDI_1_USBIO_CR1_REG |= (uint32) USBMIDI_1_USBIO_CR1_IOMODE;
        USBMIDI_1_USB_CLK_EN_REG = ~USBMIDI_1_USB_CLK_CSR_CLK_EN;
...
#if (USBMIDI_1_LPM_ACTIVE)
    /***************************************************************************
    * Function Name: USBMIDI_1_Lpm_GetBeslValue
    ************************************************************************//**
    *
    ...
    ***************************************************************************/
    ...
    {
        return (uint32) (USBMIDI_1_LPM_STAT_REG & USBMIDI_1_LPM_STAT_LPM_BESL_MASK);
    }


    /***************************************************************************
    * Function Name: USBMIDI_1_Lpm_RemoteWakeUpAllowed
    ************************************************************************//**
    *
    ...
    ***************************************************************************/
    ...
    {
        return (uint32) (USBMIDI_1_LPM_STAT_REG & USBMIDI_1_LPM_STAT_LPM_REMOTE_WAKE);
    }


    /***************************************************************************
    * Function Name: USBMIDI_1_Lpm_SetResponse
    ************************************************************************//**
    *
    ...
    *       - USBMIDI_1_LPM_REQ_ACK - next LPM request will be
    *                                           responded with ACK
    *       - USBMIDI_1_LPM_REQ_NACK - next LPM request will be
    *                                           responded with NACK
    *       - USBMIDI_1_LPM_REQ_NYET - next LPM request will be
    *                                           responded with NYET
    *
    ***************************************************************************/
    void USBMIDI_1_Lpm_SetResponse(uint32 response)
    {
        uint32 lpmCtrl = USBMIDI_1_LPM_CTRL_REG & (uint32) ~USBMIDI_1_LPM_CTRL_ACK_NYET_MASK;

        USBMIDI_1_LPM_CTRL_REG = lpmCtrl | ((uint32) response & USBMIDI_1_LPM_CTRL_ACK_NYET_MASK);
    }


    /***************************************************************************
    * Function Name: USBMIDI_1_Lpm_GetResponse
    ************************************************************************//**
    *
    ...
    *       - USBMIDI_1_LPM_REQ_ACK - next LPM request will be responded
    *                                        with ACK
    *       - USBMIDI_1_LPM_REQ_NACK - next LPM request will be responded
    *                                        with NACK
    *       - USBMIDI_1_LPM_REQ_NYET - next LPM request will be responded
    *                                        with NYET
    *
    ***************************************************************************/
    uint32 USBMIDI_1_Lpm_GetResponse(void)
    {
        ...
        return  ((uint32) USBMIDI_1_LPM_CTRL_REG & (uint32)USBMIDI_1_LPM_CTRL_ACK_NYET_MASK);
    }
