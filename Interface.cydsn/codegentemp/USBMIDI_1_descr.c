...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USBMIDI_1_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBMIDI_1_DEVICE0_CONFIGURATION0_DESCR[175u] = {
/*  Config Descriptor Length               */ 0x09u,
/*  DescriptorType: CONFIG                 */ 0x02u,
/*  wTotalLength                           */ 0xAFu, 0x00u,
...
*********************************************************************/
const uint8 CYCODE USBMIDI_1_STRING_DESCRIPTORS[421u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "Audio Control Interface"
*********************************************************************/
...
/* DescriptorType: STRING                  */ 0x03u,
 ...
 (uint8)'r', 0u,(uint8)'o', 0u,(uint8)'l', 0u,(uint8)' ', 0u,(uint8)'I', 0u,
 (uint8)'n', 0u,(uint8)'t', 0u,(uint8)'e', 0u,(uint8)'r', 0u,(uint8)'f', 0u,
 (uint8)'a', 0u,(uint8)'c', 0u,(uint8)'e', 0u,
/*********************************************************************
* String Descriptor: "MIDI Streaming Interface"
*********************************************************************/
...
/*********************************************************************
* String Descriptor: "UD3 MIDI"
*********************************************************************/
/* Descriptor Length                       */ 0x12u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'U', 0u,(uint8)'D', 0u,(uint8)'3', 0u,(uint8)' ', 0u,(uint8)'M', 0u,
 (uint8)'I', 0u,(uint8)'D', 0u,(uint8)'I', 0u,
/*********************************************************************
* String Descriptor: "UD3 UART"
*********************************************************************/
/* Descriptor Length                       */ 0x12u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'U', 0u,(uint8)'D', 0u,(uint8)'3', 0u,(uint8)' ', 0u,(uint8)'U', 0u,
 (uint8)'A', 0u,(uint8)'R', 0u,(uint8)'T', 0u,
/*********************************************************************/
...
*********************************************************************/
const uint8 CYCODE USBMIDI_1_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_USBMIDI_1_EP_SETTINGS_BLOCK CYCODE USBMIDI_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[5u] = {
/* IFC  ALT    EPAddr bmAttr MaxPktSize Class ********************/
{0x01u, 0x00u, 0x81u, 0x02u, 0x0020u,   0x01u},
{0x01u, 0x00u, 0x02u, 0x02u, 0x0020u,   0x01u},
{0x02u, 0x00u, 0x83u, 0x03u, 0x0008u,   0x02u},
{0x03u, 0x00u, 0x84u, 0x02u, 0x0040u,   0x0Au},
{0x03u, 0x00u, 0x05u, 0x02u, 0x0040u,   0x0Au}
};
const uint8 CYCODE USBMIDI_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[4u] = {
0x01u, 0x01u, 0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_USBMIDI_1_LUT CYCODE USBMIDI_1_DEVICE0_CONFIGURATION0_TABLE[7u] = {
    {0x01u,     &USBMIDI_1_DEVICE0_CONFIGURATION0_DESCR},
    {0x05u,     &USBMIDI_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USBMIDI_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USBMIDI_1_LUT CYCODE USBMIDI_1_DEVICE0_TABLE[3u] = {
    {0x01u,     &USBMIDI_1_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USBMIDI_1_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USBMIDI_1_LUT CYCODE USBMIDI_1_TABLE[1u] = {
    {0x01u,     &USBMIDI_1_DEVICE0_TABLE}
};
    ...
    *  USBMIDI_1_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USBMIDI_1_MSOS_DESCRIPTOR[USBMIDI_1_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USBMIDI_1_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USBMIDI_1_MSOS_CONFIGURATION_DESCR[USBMIDI_1_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USBMIDI_1_idSerialNumberStringDescriptor[USBMIDI_1_IDSN_DESCR_LENGTH];
